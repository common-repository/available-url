...
class Init {
	...
	private function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'admin_enqueue' ), 2 );
	}
	...
	public function constants() {
		...
		if( ! defined( 'AVAILABLEURL_VERSION' ) )
			define( 'AVAILABLEURL_VERSION', '1.4.5.0' );
	}

	public function includes() {
		include_once( AVAILABLEURL_DIR . "Utils.php" );
	...
	public function admin_enqueue() {
		// select2
		wp_register_style( 'availableurl-select2', AVAILABLEURL_URI . 'assets/css/select2.min.css', array(), AVAILABLEURL_VERSION );
		wp_register_script( 'availableurl-select2', AVAILABLEURL_URI . 'assets/js/select2.min.js', array( 'jquery' ), AVAILABLEURL_VERSION, true );
		
		wp_register_script( "availableurl", AVAILABLEURL_URI . "assets/js/backend.min.js", array( "jquery" ), AVAILABLEURL_VERSION, true );
		wp_register_style( "availableurl", AVAILABLEURL_URI . "assets/css/backend.min.css", array(), AVAILABLEURL_VERSION );
	}
